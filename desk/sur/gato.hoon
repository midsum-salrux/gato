...
::  nest is [=kind =ship name=term]
+$  bird  [text=cord =memo:channels =nest:channels =vase]
...
+$  tuna  [=reply =vase]
::  you can return either a cord or a full formatted channel message
+$  reply  $@(cord story:channels)
--
